...
export function middleware(req: NextRequest) {
  ...
  // Precise prefixes: the trailing slash on /creator/ and /partner/ is deliberate so the PUBLIC
  // directory (/creators, /partners — plural) is NOT gated, only the role areas (/creator/…).
  const AUTH_PREFIXES = ['/dashboard', '/onboarding', '/admin', '/creator/', '/partner/', '/business/', '/profile', '/messages'];
