...
/**
 * Shared searchable creator grid used by both the consultant talent-search and the business
 * "Trouver des créateurs" page. Client-side filtering over a server-rendered first page.
 */
