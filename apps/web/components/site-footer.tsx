    ...
    <footer className="border-t border-line">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 py-8 sm:flex-row">
        ...
        <div className="flex items-center gap-5 text-[13px] text-muted">
          <Link href="/legal#cgu" className="hover:text-brand">{t.footer.cgu}</Link>
          <Link href="/legal#privacy" className="hover:text-brand">{t.footer.privacy}</Link>
          <Link href="/legal#ohada" className="hover:text-brand">{t.footer.ohada}</Link>
        </div>
      </div>
    </footer>
  );
